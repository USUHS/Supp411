			...
			c.className="reflected"
				...
				if(b.attr!=undefined){
					if(b.attr.style!=undefined){
						m.style.cssText=b.attr.style;
					}
				}
				if(b.attr!=undefined){
					if(b.attr.cls!=undefined){
						m.className=b.attr.cls
					}
				}	
						
			}
			
			if(c.complete){d()}else{a(c).load(d)}}})},unreflect:function(){return this.unbind("load").each(function(){var c=this,b=a.data(this,"reflected"),d;if(b!==undefined){d=c.parentNode;c.className=d.className;c.style.cssText=b;a.removeData(c,"reflected");d.parentNode.replaceChild(c,d)}})}})})(jQuery);
